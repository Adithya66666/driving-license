export default function DriverList(){
    return <>
        <div className="w-[100%]">
        <div className="p-8">
          <h1 className="font-bold text-xl">Search Driver's License</h1>
            ...
            <div className="flex">
                <div className="border border-gray-300 rounded-lg py-2 px-4 bg-white mr-2">
                    <form method="POST">
                        ...
                        <input type="text" className="outline-none text-s text-gray-400 w-[300px]" placeholder="Search License Number #"/>
                    </form>
                </div>
            ...
            <table className="min-w-full divide-y divide-gray-200 mt-6">
                <thead>
                    <tr>
                        ...
                        <th scope="col" className="px-6 py-3 bg-gray-50 text-xs font-medium text-gray-500 uppercase tracking-wider">DOI</th>
                        <th scope="col" className="px-6 py-3 bg-gray-50 text-xs font-medium text-gray-500 uppercase tracking-wider">DOE</th>
                        <th scope="col" className="px-6 py-3 bg-gray-50 text-xs font-medium text-gray-500 uppercase tracking-wider">Category</th>
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                    <tr className="cursor-pointer">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-center">2034/04/02</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-center">A1</td>
